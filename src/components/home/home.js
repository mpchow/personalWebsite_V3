   ...
   render() {
      return (
         <div className="home">
            ...
            <h4>Former intern at <a href="https://www.sap.com/canada/" className="SAP" target="_blank" rel="noopener noreferrer">SAP</a>, <a href="http://perklabs.io" className="Perk" target="_blank" rel="noopener noreferrer">Perk Labs</a></h4>
